...
const Onboarding = () => {
     ...
     const imageChange1 = (e) => {
          if (e.target.files && e.target.files.length > 0) {
               ...
               if (imageSize > 300000){
                    setInsuranceFormData({ ...insuranceFormData, [name]: {} });
                    toast.error("O tamanho máximo suportado é de 300 Kb, por favor tente de novo")
     ...
     const removeSelectedImage1 = () => {
          setSelectedImage1();
          setInsuranceFormData({ ...insuranceFormData, idUp: {} });
     };
     ...
     const removeSelectedImage2 = () => {
          setSelectedImage2();
          setInsuranceFormData({ ...insuranceFormData, idBack: {} });
     };
                                   ...
                                   <form>
                                        <div className={selectedImage1 ? 'ccPhotoBtn_1' : 'ccPhotoBtn_1_e'}>
                                             ...
                                             {selectedImage1 ?
                                                  ...
                                                  :
                                                  <div className='imageUploadsection' type='button'>ADICIONAR<br /><p>FOTO FRENTE</p><br/>(Tamanho max.0.3MB)</div>
                                             }
                                             {selectedImage1 && (
                                        ...
                                        <div className={selectedImage2 ? 'ccPhotoBtn_2' : 'ccPhotoBtn_2_e'}>
                                             {selectedImage2 ?
                                                  ...
                                                  :
                                                  <div className='imageUploadsection' type='button'>ADICIONAR<br /><p>FOTO VERSO</p><br/>(Tamanho max.0.3MB)</div>
                                             }
